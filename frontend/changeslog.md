...
| 2025-08-27 | <ADD NAME> | Feature | Implemented Login page (modern Fluent UI form, Microsoft sign-in button), routing update (/login), ProtectedRoute redirect logic, vitest + Testing Library setup, initial tests |
